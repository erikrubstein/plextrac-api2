...
def request_presigned_upload_url(session: AuthSession, upload: FindingImportUpload) -> PresignedUpload:
...
def import_preuploaded_findings(session: AuthSession, client_id: int | str, report_id: int | str, source: FindingImportSource, upload: FindingImportUpload) -> OperationResult:
...
def list_import_statuses(session: AuthSession) -> list[FindingImportStatus]:
...
def get_scanner_output(session: AuthSession, client_id: int | str, report_id: int | str, finding_id: int | str, asset_id: int | str) -> bytes:
...
def update_finding_evidence(session: AuthSession, client_id: int | str, report_id: int | str, finding_id: int | str, asset_id: int | str, evidence_id: int | str, evidence: FindingEvidenceUpdate) -> OperationResult:
...
def bulk_upsert_finding_evidence(session: AuthSession, tenant_id: int | str, client_id: int | str, report_id: int | str, finding_id: int | str, evidence: list[FindingEvidenceUpdate]) -> OperationResult:
...
def list_report_findings(session: AuthSession, client_id: int | str, report_id: int | str, *, pagination: FindingPagination | None = None, sort: list[FindingSort] | None = None, filters: list[FindingFilter] | None = None) -> FindingPage:
...
def get_finding(session: AuthSession, client_id: int | str, report_id: int | str, finding_id: int | str) -> Finding:
...
def create_finding(session: AuthSession, client_id: int | str, report_id: int | str, finding: FindingInput) -> OperationResult:
...
def update_finding(session: AuthSession, client_id: int | str, report_id: int | str, finding_id: int | str, finding: FindingInput) -> OperationResult:
...
def bulk_update_findings_metadata(session: AuthSession, client_id: int | str, report_id: int | str, finding_ids: list[int | str], *, tags: list[str] | None = None, created_at: int | None = None, visibility: FindingVisibility | None = None) -> OperationResult:
...
def bulk_update_finding_statuses(session: AuthSession, client_id: int | str, finding_ids: list[int | str], *, status: FindingStatus | None = None, substatus: str | None = None, substatus_cuid: str | None = None, assigned_to: str | None = None, comments: str | None = None) -> OperationResult:
...
def delete_finding(session: AuthSession, client_id: int | str, report_id: int | str, finding_id: int | str) -> OperationResult:
...
def bulk_delete_findings(session: AuthSession, client_id: int | str, report_id: int | str, finding_ids: list[int | str]) -> OperationResult:
...
def list_finding_status_updates(session: AuthSession, client_id: int | str, report_id: int | str, finding_id: int | str) -> list[FindingStatusUpdate]:
...
def create_finding_status_update(session: AuthSession, client_id: int | str, report_id: int | str, finding_id: int | str, update: FindingStatusUpdate) -> OperationResult:
